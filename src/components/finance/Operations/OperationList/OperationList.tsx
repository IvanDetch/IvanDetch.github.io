...
const OperationList: React.FC<OperationListProps> = ({ items = [], pageSize = DEFAULT_PAGE, useInfinite = true, unlimited = false }) => {
  const [data, setData] = useState<Operation[]>(() => items.length ? items : Array.from({length: pageSize}, () => createRandomOperation()));
